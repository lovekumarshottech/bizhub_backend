  ...
  var Vim = function() {
    ...
    MacroModeState.prototype = {
      ...
      enterMacroRecordMode: function(cm, registerName) {
        var register =
            vimGlobalState.UserController.getRegister(registerName);
        if (register) {
          register.clear();
    ...
    var vimApi= {
      ...
      getUserController: function() {
        return vimGlobalState.UserController;
      },
      // Testing hook.
    ...
    function defineRegister(name, register) {
      var registers = vimGlobalState.UserController.registers;
     ...
     *
     * UserController keeps the state of all the registers.  An initial
     * state may be passed in.  The unnamed register '"' will always be
     * overridden.
     */
    function UserController(registers) {
    ...
    * match the input selection.
    ...
    var operators = {
      change: function(cm, args, ranges) {
        ...
        vimGlobalState.UserController.pushText(
    ...
    var actions = {
      ...
      enterMacroRecordMode: function(cm, actionArgs) {
        var macroModeState = vimGlobalState.macroModeState;
        var registerName = actionArgs.selectedCharacter;
        if (vimGlobalState.UserController.isValidRegister(registerName)) {
      ...
      paste: function(cm, actionArgs, vim) {
        ...
        var register = vimGlobalState.UserController.getRegister(
        ...
        if (vim.visualMode) {
          ...
          vimGlobalState.UserController.unnamedRegister.setText(selectedText);
          if (blockwise) {
    ...
    * in the right place.
    ...
    function parseQuery(query, ignoreCase, smartCase) {
      ...
      var lastSearchRegister = vimGlobalState.UserController.getRegister('/');
    ...
    ExCommandDispatcher.prototype = {
      ...
      _processCommand: function(cm, input, opt_params) {
        var vim = cm.state.vim;
        var commandHistoryRegister = vimGlobalState.UserController.getRegister(':');
    ...
    */
    ...
    function exitInsertMode(cm) {
      var vim = cm.state.vim;
      var macroModeState = vimGlobalState.macroModeState;
      var insertModeChangeRegister = vimGlobalState.UserController.getRegister('.');
    ...
    function executeMacroRegister(cm, vim, macroModeState, registerName) {
      var register = vimGlobalState.UserController.getRegister(registerName);
      if (registerName == ':') {
