...
use App\Http\Requests\{ServiceFiltersRequest, StoreServiceRequest, StoreServiceApplicationRequest};
...
class ServiceController extends BaseController
{
    ...
    public function getMyServices(Request $request){
        ...
        $services = Service::whereHas('user', function($q){
            $q->where('user_id',  request()->user()->id);
        })->withCount('applications')->with(['user','category','applications'  => function($q){ $q->with(['user','comments'
...
// Abd Function End
    ...
    public function getAppliedServices(Request $request){
        ...
        $services = Service::with(['user','category','applications'  => function($q){ $q->with(['user','comments'
            => function($q){ $q->orderBy('created_at', 'DESC'); }
        ]); }
